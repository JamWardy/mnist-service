...
# CORS (Cross-Origin Resource Sharing) Policy needed because the front and back-end have different origins

# Middleware - runs before and after every request
app.add_middleware(
    CORSMiddleware,
    # Allow all origins - fix in prod (Vite default is 5173)
    allow_origins=["*"], 
    allow_credentials=True,
    # Allow all HTTP methods - could change to POST / GET
    allow_methods=["*"],
